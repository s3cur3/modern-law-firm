...
function roots_theme_activation_options_add_page()
{
    ...
    if (!$roots_activation_options) {
        $theme_page = add_theme_page(
            __('Theme Activation', MLF_TEXT_DOMAIN),
            __('Theme Activation', MLF_TEXT_DOMAIN),
            'edit_theme_options',
...
function roots_theme_activation_options_render_page()
{
    ?>
    <div class="wrap">
        <h2><?php printf(__('%s Theme Activation', MLF_TEXT_DOMAIN), wp_get_theme()); ?></h2>

        <div class="update-nag">
            <?php _e('These settings are optional and should usually be used only on a fresh installation', MLF_TEXT_DOMAIN); ?>
        </div>
        <?php settings_errors(); ?>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('Create static front page?', MLF_TEXT_DOMAIN); ?>  (recommended)</th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Create static front page?', MLF_TEXT_DOMAIN); ?></span></legend>
                            <select name="roots_theme_activation_options[create_front_page]" id="create_front_page">
                                <option selected="selected" value="true"><?php echo _e('Yes', MLF_TEXT_DOMAIN); ?></option>
                                <option value="false"><?php echo _e('No', MLF_TEXT_DOMAIN); ?></option>
                            </select>

                            <p class="description"><?php printf(__('Create a page called Home and set it to be the static front page', MLF_TEXT_DOMAIN)); ?></p>
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Change permalink structure?', MLF_TEXT_DOMAIN); ?>  (recommended)</th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Update permalink structure?', MLF_TEXT_DOMAIN); ?></span></legend>
                            ...
                            <p class="description"><?php printf(__('Change permalink structure to /&#37;postname&#37;/', MLF_TEXT_DOMAIN)); ?></p>
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Create navigation menu?', MLF_TEXT_DOMAIN); ?> (recommended)</th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text">
                                <span><?php _e('Create navigation menu?', MLF_TEXT_DOMAIN); ?></span></legend>
                            ...
                            <p class="description"><?php printf(__('Create the Primary Navigation menu and set the location', MLF_TEXT_DOMAIN)); ?></p>
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php _e('Add pages to menu?', MLF_TEXT_DOMAIN); ?></th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e('Add pages to menu?', MLF_TEXT_DOMAIN); ?></span>
                            </legend>
                            ...
                            <p class="description"><?php printf(__('Add all current published pages to the Primary Navigation', MLF_TEXT_DOMAIN)); ?></p>
                        </fieldset>
                    </td>
                </tr>
            </table>
